      ...
      <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-sky-50 via-white to-cyan-50 flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <h1 className="text-4xl sm:text-4xl lg:text-5xl font-bold leading-tight text-slate-900">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <button
                ...
                className="bg-sky-600 text-white px-7 py-3.5 rounded-2xl font-semibold hover:bg-sky-700 transition shadow-lg"
              >
                Get Started
              </button>
          ...
          <div className="relative">
            ...
            <img
              ...
              alt="doctor"
              className="relative w-full h-[400px] lg:h-[480px] object-cover rounded-2xl shadow-2xl"
            />
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600 max-w-md">
                Book doctors, order medicines, and schedule lab tests — all in
                one place.
              </p>
            </div>
            ...
            <div className="flex gap-3">
              <button
                onClick={() => navigate("/login")}
                className="bg-sky-600 text-white px-5 py-2.5 rounded-lg font-medium hover:bg-sky-700 transition"
              >
                Get Started
              </button>
